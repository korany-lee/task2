...
$(function(){
	$("#btn").click(function(){
		if($("#btn").attr("value") == "삭제"){
			$("#btn").attr("value","삭제취소");
			$("#fileDel").val("${reviews.reviewImage}");
			$("#imageView").html(
	...
	<div id = "wrap">
			...
			<div class="contents">
				...
				<div class="relCon">
					...
					<form action="safeReviewModifyPro.sm" method="post" id = "frm" name="reviewForm" enctype="multipart/form-data">
						<table>
						<tr>
							<th style="width: 100px;">등록자</th>
								<td>
									<input type="text" name="userName" id="userName" value = "${reviews.userName }" />
								</td>
						</tr>
						...
						<tr>
							<th style="width: 100px;">제목</th>
								<td>
									<input type="text" name="reviewSubject" id="reviewSubject" value = ${reviews.reviewSubject } />
								</td>
						</tr>
						...
						<tr>
							<tr>
								<th style="width: 100px;">이미지</th>
									<td>${revires.reviewImage }<input type="button" id="btn"
										value="삭제" /> <img src="SafeMall/review/${reviews.reviewImage }"
										width="30" height="30" />
									</td>
								</tr>
							<tr>
									<th style="width: 100px;">이미지 수정</th>
