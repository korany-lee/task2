...
<body>
	<div id="wrap">
		...
		<div id="container" align="center">
			<div id="contents" style="margin-top: 160px;">
				...
				<div class="xans-element- xans-product xans-product-normalpackage ">
					<div class="xans-element- xans-product xans-product-normalmenu ">
						<!-- 상품 수 출력 -->
						<div class="function">
							<p class="prdCount">[${reviewCount }]REVIEW</p>
						</div>
						<!-- 상품 수 출력 종료 -->
					</div>
				</div>
				...
				<c:if test = "${!empty reviews }">
					...
					<c:forEach var="review" items="${reviews }" varStatus="status" step="1">
							<tr align="left" valign="middle" bordercolor="#333333"
								...
								<td>
									<div align="center">
										...
										<a href="reviewDetail.sm?num=${review.reviewNum }"><img src="SafeMall/review/${review.reviewImage }" width = "80px" height = "80px"/></a>
									</div>
								</td>

								<td >
									<div align="center">${review.userSatis }</div>
								</td>
								<td >
									<div align="center">
								...
								<td >
									<div align="center">${ review.userName }</div>
								</td>
								...
								<td >
									<div align="center">${ review.reviewCount }</div>
								</td>
			...
			<c:if test="${page >1 }">
				<a href="safeMallReview.sm?page=${page -1 }"><img src = "images/safemall/btn_page_prev.gif"/></a>
        	</c:if>
        	
        	
          	<c:forEach begin="${startPage }" end="${endPage }" step="1" var="i">
				<span class="xans-record-"><a href="safeMallReview.sm?page=${i }">${i}</a></span>
			</c:forEach> 
			...
			<c:if test="${page >= maxPage}">
       		 ...
       		 <c:if test="${page < maxPage}">
				<a href="safeMallReview.sm?page=${page +1 }"> <img src = "images/safemall/btn_page_next.gif"/></a>
			</c:if>
				...
				<div id="reviewEmpty">
					<table>
						<tr align="center" valign="middle">
							<td align=right><font size=2>등록된 후기가 없습니다!</font></td>
						</tr>
