	...
	<div id = "wrap">
			...
			<div class="contents">
				...
				<div class="relCon">
					...
					<form action="replyModifyPro.sm" method="post" id = "frm" name="replyForm">
						<table>
						<tr>
								...
								<td>
									<select name="replySubject" id="replySubject" class="select"
												style="width: 150px;" req fname="문의 제목">
													<option value='상품관련 답변입니다.'>상품문의 답변입니다.</option>
													<option value='배송관련 답변입니다.'>배송문의 답변입니다.</option>
						...
						<input type = "hidden"	value = "${reply.replyNum }" name = "replyNum" id = "replyNum">
