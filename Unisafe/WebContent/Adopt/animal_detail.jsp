	...
	<div id="page" class="hfeed site">
		...
		<div class="wrapper" id="single-wrapper">
			<div id="content" class="container ">
				...
				<div id="primary" class="row content-area">
					<div class="entry-content col-xs-12 col-md-6 my-5 pr-5">
						<article id="post-19915"
							...
							<p>${animalDetail.aniName } 은(는) 아래와 같은 특성이 있습니다. </p>
							<c:forTokens var="char1" items="${animalDetail.aniChar }" delims=",">
							 - ${char1 } <br/>
							</c:forTokens>
						</article>
					</div>
					<div class="col-xs-12 col-md-5 col-lg-4 my-5">
						<div id="animal-crits" class="kriterien row animal-crits">
							
								<button class="btn btn-primary text-white mb-3" type="button"
									name="button" onclick="location.href='reservation.at?num='+${animalDetail.aniNum} ">입양하기</button>
							...
							<table class="col-12 table tierattribute">
								...
								<tbody>
									...
									<tr>
										<td>성별</td>
										<td>
										<c:forTokens var="gender" items="${animalDetail.aniGender }" delims="," >
											${gender }&nbsp;
										</c:forTokens>
										</td>
									</tr>
									<tr>
										<td>종</td>
										<td>${animalDetail.race }</td>
									</tr>
									<tr>	
										<td>사이즈</td>
										<td>${animalDetail.aniSize }</td>
									</tr>
									<tr>
										<td>생일</td>
										<td>${animalDetail.aniBirth }</td>
									</tr>
									<tr>
										<td>보호소 입소 날짜</td>
				...
				<button class="btn btn-primary text-white mb-3" type="button"
					name="button" onclick="window.close()">닫기</button>
