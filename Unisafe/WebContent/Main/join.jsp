...
<body>
   <div id="wrap">
      <div id="top" align="right">
         <img src="images/unisafeLogo1.png" alt="로고">
      </div>
      <hr class="a">
      <div id="left"></div>
      ...
      <div id="content">
         ...
         <div id="joinInfo" >
            <ul>
               <li>유니세이프한국위원회는 2013년 2월 18일부터 <span>정보통신망 이용 촉진 및 정보보호등에 관한 법률 제 23조 조항에 의거, 홈페이지의 웹회원 가입 시 주민등록번호나 주소 등의 개인정보를 수집하지 않습니다.</span></li>
               <li>아이디/비밀번호 분실 시 이를 다시 발급 받으려면 본인 확인절차를 거쳐야 하므로 <span>실명과 실제 사용하는 연락처를 입력</span>해주세요.</li>
         ...
         <div id="p1" align="right">
            <h5>
               <span>'*'</span> 필수 입력 항목입니다.
            </h5>
         </div>
         
         <div id="memberInfo" align="center" class="table11">
            <form action="memberJoinPro.us" method="post">
               <table summary="회원가입" border="0" cellpadding="0" cellspacing="0"
                  style="table-layout: fixed;">
                  <colgroup><col width="144" /><col width="*" /></colgroup>
                  <tbody>
                     <tr>
                        <th><span>*</span><label for="">아이디</label></th>
                        <td><input type="text" name="m_userid" id="m_userid"
                           class="input_text"
                           style="width: 183px; ime-mode: disabled; text-transform: lowercase;"
                           req fname="아이디" maxlength="16" /> <input type="button"
                           value="중복확인"> <a class="layer" data-position="iframe"
                           id="id_overlap_hidden"></a></td>
                     </tr>
                     ...
                     <tr>
                        ...
                        <td><input type="password" name="m_userpass2"
                           id="m_userpass2" class="input_text" style="width: 183px;" req
                           fname="비밀번호 확인" maxlength="20" onblur="pwdpcheck();" /> <span
                           class="agree" id="spn_passConfirm_msg"></span></td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        ...
                        <td><select name="m_m_tel1" id="m_m_tel1" class="select"
                           ...
                           style="width: 48px;" req num fname="휴대폰 번호" maxlength="4" /></td>
                     </tr>
                     <tr>
                        ...
                        <td><input type="text" name="m_email1" id="m_email1"
                           ...
                           style="width: 148px;" title="이메일 주소 선택">
                        ...
                        <p class = "mt5"><span>신청하신 이메일로 가입확인 이메일을 발신합니다</span><p></td>
                     </tr>
                     <tr>
                        ...
                        <td><span>법령에 따라 만 14세 미만 아동 여부를 확인하기 위하여 가입자 본인의
                           ...
                           <div class="newsCheck" style="margin-top: 10px;">
                              <select name="year_select" id="year_select" class="select" req
                                 fname="생년월일(년)">
                              ...
                              </select>&nbsp;년 &nbsp;&nbsp;<select name="month_select"
                              ...
                              </select>&nbsp;월 &nbsp;&nbsp;<select name="day_select" id="day_select"
                                 class="select" req fname="생년월일(일)">
                                 <option value=''>-선택-</option>
